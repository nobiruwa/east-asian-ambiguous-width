...
echo "文字幅の比較結果をoutput/ambiguous_width_comparison.txtに出力します"
mkdir -p output
bin/ambiguous_width_comparison "/usr/share/fonts/truetype/vlgothic/VL-Gothic-Regular.ttf" > output/ambiguous_width_comparison.txt
